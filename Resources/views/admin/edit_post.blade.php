...
@section('content')
    <div class="row">
        ...
        <div class="col-md-12">
            {{-- dd(public_path()) --}}
            <div class="box">
                <div class="box-header with-border"><h3 class="box-title">{{trans('iblog::post.form.gallery')}}</h3>
                ...
                <div style="padding:0 15px 20px">
                    <form id="real-dropzone" class="dropzone" enctype="multipart/form-data"
                          action="{{URL::route('iblog.gallery.upload')}}" method="post">
                        <div class="row">
                            <h4 style="text-align: center;">{{trans('iblog::post.form.drag')}}<i
                            ...
                            <div class="dz-message"><span class="h4">{{trans('iblog::post.form.click')}}</span></div>
