    ...
    <div class="row">
        <div class="col-xs-12 col-md-9">
            <div class="row">
                ...
                @if (config('asgard.iblog.config.category.partials.normal.edit') && config('asgard.iblog.config.category.partials.normal.edit') !== [])
                ...
                <div class="col-xs-12 ">
                    <div class="box box-primary">
                        ...
                        <div class="box-body ">
                            @foreach (config('asgard.iblog.config.category.partials.normal.edit') as $partial)
                            @include($partial)
                            @endforeach
                        ...
                        <div class="box-body">
                            <select class="form-control" name="parent_id" id="parent_id">
                                ...
                                @foreach ($categories as $parent)
                                    <option value="{{$parent->id}}" {{ old('parent_id', $category->id) == $parent->id ? 'selected' : '' }}> {{$parent->title}}
                                    </option>
                                @endforeach
                            </select><br>
                        </div>
