...
<div class="row">
		...
		@endif
		  ...
		  <div class="box">
		    ...
		    <div class="box-body row">
		      ...
		      @else
		      	@include('iblog::admin.form_content', ['fields' => $crud->getFields('update', $entry->getKey())])
		      @endif
	...
	{{-- dd(public_path()) --}}
	    ...
	    <h3>Galeria </h3>
	    <br />
		<form id="real-dropzone" class="dropzone" enctype="multipart/form-data" action="{{url('/backend/iblog/category/upload/image')}}" method="post">
			<div class="row">
				<h4 style="text-align: center;">Arrastre y suelte aqui <i class="glyphicon glyphicon-download-alt" aria-hidden="true"></i></h4>
	            ...
	            <div class="dropzone-previews" id="dropzonePreview">
	            	...
	            	@foreach(Storage::disk('publicmedia')->files('assets/iblog/post/gallery/' . $entry->id) as $image)
	            		<div class="dz-preview dz-processing dz-image-preview dz-complete">
		        			...
		        			<a class="dz-remove btn btn-danger btn-xs" href="javascript:undefined;"  onclick="$.deleteFile(this)" dir-data="{{ $image }}">Eliminar</a>
		        		</div>
	            	@endforeach
...
<link href="{{ asset('modules/iblog/vendor/dropzone/dropzone.min.css') }}" rel="stylesheet" type="text/css" />
<script src="{{ asset('modules/iblog/vendor/dropzone/dropzone.min.js') }}"></script>
<script src="{{ asset('modules/iblog/vendor/dropzone/dropzone-config.js') }}"></script>
