...
@if ($crud->checkIfFieldIsFirstOfItsType($field, $fields))
   ...
   {{ Theme::script('vendor/admin-lte/plugins/daterangepicker/moment.min.js') }}
    ...
    @if ($field_language !== 'en')
        {{ Theme::script('vendor/admin-lte/plugins/datepicker/locales/bootstrap-datepicker.'.$field_language.'.js') }}
