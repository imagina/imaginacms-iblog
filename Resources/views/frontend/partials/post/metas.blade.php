...
<meta property="og:description" content="{{$post->meta_description ?? strip_tags($post->summary) ?? strip_tags($post->description)}}"/>
...
<meta name="twitter:description" content="{{$post->meta_description ?? strip_tags($post->summary) ?? strip_tags($post->description)}}">
